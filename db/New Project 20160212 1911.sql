...
--
-- Definition of table `lookup_position`
--

DROP TABLE IF EXISTS `lookup_position`;
CREATE TABLE `lookup_position` (
  `id` int(11) NOT NULL,
  `position_name` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'ตำแหน่ง',
  PRIMARY KEY (`id`)
...
/*!40000 ALTER TABLE `lookup_position` DISABLE KEYS */;
INSERT INTO `lookup_position` (`id`,`position_name`) VALUES 
 (1,'แพทย์ปฏิบัติการ'),
 (2,'แพทย์ชำนาญการ'),
 (3,'ทันตแพทย์'),
 (4,'จพ.ทันตสาธารณสุข'),
 ...
 (12,'พยาบาลชำนาญงาน'),
 (13,'พยาบาลเทคนิค'),
 (14,'พยาบาลเทคนิคชำนาญงาน'),
 (15,'ผู้ช่วยพยาบาล'),
 (16,'พนักงานช่วยเหลือคนไข้'),
 (17,'นักเทคนิคการแพทย์'),
 (18,'จพ.วิทยาศาสตร์การแพทย์'),
 (19,'นักแผนไทย'),
 (20,'นักกายภาพบำบัด'),
 (21,'นักวิทยาศาสตร์การกีฬา'),
 (22,'จพ.เวชกิจฉุกเฉิน'),
 (23,'จพ.รังสี'),
 (24,'นักโภชนาการ'),
 (25,'นักจัดการงานทั่วไป'),
 (26,'นักวิชาการคอมพิวเตอร์'),
 (27,'พนักงานคอมพิวเตอร์'),
 (28,'นักวิชาการเงินและบัญชี'),
 (29,'เจ้าพนักงานการเงินและบัญชี'),
 (30,'จพ.ธุรการ'),
 (31,'จพ.เวชสถิติ'),
 (32,'นักวิชาการสาธารณสุข'),
 (33,'จพ.สาธารณสุข'),
 (34,'จพ.โสต'),
 (35,'ผู้ช่วยอนามัย'),
 (36,'พนักงานทั่วไป'),
 (37,'พนักงานบริการ'),
 (38,'เจ้าหน้าที่ห้องบัตร'),
 (39,'เจ้าหน้าที่บันทึกข้อมูล'),
 (40,'คนงานบริการด้านอาหาร');
/*!40000 ALTER TABLE `lookup_position` ENABLE KEYS */;
...
CREATE TABLE `person` (
  ...
  `person_birthday` date DEFAULT NULL COMMENT 'วันเกิด',
  ...
  `person_worked` date DEFAULT NULL COMMENT 'วันที่บรรจุ',
  `person_workin` date DEFAULT NULL COMMENT 'วันที่เข้าทำงาน',
  ...
  `person_province` int(11) DEFAULT NULL,
  `person_amphur` int(11) DEFAULT NULL,
  `person_district` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `person` (`id`,`person_id`,`person_cid`,`person_pname`,`person_fullname`,`person_oname`,`person_birthday`,`person_age`,`person_sex`,`person_address`,`person_status`,`person_blod`,`person_phon`,`person_email`,`person_worked`,`person_workin`,`person_may`,`person_dad`,`person_mum`,`person_department`,`person_status_now`,`person_position`,`person_license_number`,`person_education`,`person_type`,`person_salary`,`person_photo`,`person_province`,`person_amphur`,`person_district`) VALUES 
 (1,'001','1-4203-00053-16-3','1','ดนัย สอนไสย','','1988-04-16',28,'1','52/8 หมู่ 2 ซอย 21','2','2','084-7931944','Lifegoon_2006@hotmail.com','2011-08-17','2011-08-17','กรรณิการ์ พิลากอง','นัฐวัฒิ สอนไสย','พนมยงค์ สอนไสย','20','1','26','12345678','3','3',12000,'aced74a3b13c922097ebf1f7c8778331.jpg',5,8,11),
 (2,'002','0-0000-00000-00-0','1','ชลากร จันทรัตน์','','1990-01-01',38,'1','โรงพยาบาเชียงคาน','2','4','081-2345678','123@hotmail.com','2016-02-10',NULL,'','','','16','1','31','','3','1',20000,'1e736cb3d23de2f24d5f384572e37686.jpg',6,9,12),
 (3,'','1-4299-00209-88-0','1','กิตติศักดิ์ ยศปัญญา','','1994-10-07',21,'1','9 หมู่ 3 บ้านนาพระ ตำบลนาพึง อำเภอนาแห้ว จังหวัดเลย 42170','1','2','092-5511001','forfeww@hotmail.com','2015-08-17','2015-08-17','-','ไหมพรม ยศปัญญา','เรือน ยศปัญญา','20','1','34','','6','6',8985,'b521c292495cc092ab37d023cf456811.jpg',7,10,13);
...
CREATE TABLE `training` (
  ...
  `training_start` date NOT NULL COMMENT 'วันที่อบรม',
  `training_end` date NOT NULL COMMENT 'วันที่กลับ',
...
INSERT INTO `training` (`id`,`person_id`,`training_year`,`training_start`,`training_end`,`training_budget`,`training_book_number`,`training_type`,`training_total`,`training_unit`,`training_course`,`training_location`) VALUES 
 (1,1,'1','2016-02-06','2016-02-06','2000','12345','2','8','2','อบรมหลักสูตร YII2 Feramwork ','จ.ขอนแก่น');
...
INSERT INTO `user` (`id`,`username`,`auth_key`,`password_hash`,`password_reset_token`,`email`,`status`,`created_at`,`updated_at`,`role`) VALUES 
 ...
 (2,'kittisak','tlTiOqd6_sppFRItSR55zrB0YL1_ljT1','$2y$13$go5srWQY4T7AZZPooeaqX.K739COMekjEypWa3He98VDX1VHqOqiq',NULL,'kittisak@hotmail.com',10,1455086551,1455086551,20),
 (3,'admin','ltL-R69-Vnv4S42d3ws-3HUOUT1wayQm','$2y$13$/SnMwypvbYU9CEVU2ZEQFeMzJ1NirVFLnyJgkJFO9bdNmnQQVJBPK',NULL,'admin@hotmail.com',10,1455264217,1455264217,20);
