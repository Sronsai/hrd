...
$this->title = 'รายงานบุคลากร รพ.เชียงคาน แยกประเภท';

//use yii\helpers\Url;

$this->params['breadcrumbs'][] = ['label' => 'รายงาน', 'url' => ['/report/index']];
$this->params['breadcrumbs'][] = 'รายงานบุคลากร รพ.เชียงคาน แยกประเภท';
?>

<div class="report">
    <center><h1><u>รายงานบุคลากร รพ.เชียงคาน แยกประเภท</u></h1></center>
    ...
    <div class="row">
        ...
        <!--h4><i class="icon fa fa-bar-chart"></i> รายการความเสี่ยงทั้งหมด</h4-->
            <form method="POST"> 
                ...
                <div class="col-lg-2">
                    <?php
                    $list = yii\helpers\ArrayHelper::map(frontend\models\LookupType::find()->all(), 'id', 'type_name');
                    echo yii\helpers\Html::dropDownList('type_name', $type, $list, [
                        'prompt' => 'เลือกประเภท',
                        'class' => 'form-control',
                    ]);
                    ?>
